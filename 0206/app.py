...
default_characters = [
    {
        "name": "秩序守護者", "image": "reformer.png",
        "nickname": "正義之聲", "age": 40, "job": "倫理專家",
        "personality": "嚴謹、有原則",
    ...
    {
        "name": "心靈守護者", "image": "helper.png",
        "nickname": "暖心夥伴", "age": 35, "job": "心理輔導師",
    ...
    {
        "name": "夢想驅動者", "image": "achiever.png",
        "nickname": "奮鬥達人", "age": 30, "job": "企業家",
    ...
    {
        "name": "靈魂詩人", "image": "individualist.png",
        "nickname": "藝術追尋者", "age": 28, "job": "作家",
        "personality": "感性，創意豐富",
    ...
    {
        "name": "智慧探索者", "image": "observer.png",
        "nickname": "知識探索者", "age": 45, "job": "科學家",
    ...
    {
        "name": "忠誠守護者", "image": "loyalist.png",
        "nickname": "安全顧問", "age": 38, "job": "安全專家",
    ...
    {
        "name": "冒險王", "image": "enthusiast.png",
        "nickname": "活力四射", "age": 27, "job": "旅行家",
    ...
    {
        "name": "果斷統帥", "image": "challenger.png",
        "nickname": "領袖之道", "age": 42, "job": "企業領袖",
    ...
    {
        "name": "靜心者", "image": "peacemaker.png",
        "nickname": "和平追尋者", "age": 36, "job": "靈修導師",
...
@app.route("/custom_partner")
def custom_partner_page():
    if "user" not in session:
        flash("請先登入！", "error")
        return redirect(url_for("login"))
    
    user = session["user"]
    character = characters_collection.find_one({"owner": user}, {"_id": 0})
    
    return render_template("custom_partner.html", character=character)
