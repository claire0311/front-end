...
default_characters = [
    ...
    {
        "name": "靈魂詩人", "image": "individualist.jpg",
    ...
    {
        "name": "果斷統帥", "image": "challenger.jpg",
